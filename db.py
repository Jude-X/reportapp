...
def data_table(c):
	...
	Merchants VARCHAR() DEFAULT NULL,
	country VARCHAR() DEFAULT NULL,
	Product VARCHAR() DEFAULT NULL,
	Product2 VARCHAR() DEFAULT NULL,
	Product3 VARCHAR() DEFAULT NULL,
	TPV$ DECIMAL(15,2) DEFAULT 0,
	Rev$ DECIMAL(15,2) DEFAULT 0,
	Day SMALLINT DEFAULT NULL CHECK (Day<=32),
	Product4 VARCHAR() DEFAULT NULL,
	Week SMALLINT DEFAULT NULL CHECK (Week<=53),
	Vertical VARCHAR() DEFAULT NULL,
	Global VARCHAR() DEFAULT NULL,
	Product_FX VARCHAR() DEFAULT NULL,
	New_Ex VARCHAR() DEFAULT NULL,
	MerchName2 VARCHAR() DEFAULT NULL,
	Category VARCHAR() DEFAULT NULL,
	Classification VARCHAR() DEFAULT NULL,
	Quarter SMALLINT DEFAULT NULL CHECK (Quarter<=5),
	DayOfWeek SMALLINT DEFAULT NULL CHECK (DayOfWeek<=10),
	DayName VARCHAR() DEFAULT NULL,
